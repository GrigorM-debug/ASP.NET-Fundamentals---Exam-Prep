    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false, comment: "The type unique identifier")
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false, comment: "The event unique identifier")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ...
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false, comment: "The date and time when the event is created"),
                    ...
                    OrganizerId = table.Column<string>(type: "nvarchar(450)", nullable: false, comment: "The organizer of the event unique identifier"),
